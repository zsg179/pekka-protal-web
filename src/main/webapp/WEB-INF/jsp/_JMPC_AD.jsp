...
<div class=item-rank>
	...
	<div class=rank-body>
	<c:forEach items="${JMPCItemRanking }" var="JMPC">
		<div class=rank-body-item>
			<a class="rank-body-item-link">
				<div class="item-link-img" style="margin-left: -15px;">
					<div class="lazyimg" style="background: transparent none repeat scroll 0% 0%;" alt="${JMPC.title }" title="${JMPC.title }">
						<img class="imgloaded" src="${JMPC.image }" alt="${JMPC.title }" />
					</div>
				</div>
