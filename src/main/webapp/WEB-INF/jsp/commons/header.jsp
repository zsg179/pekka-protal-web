...
<!--shortcut end-->
<div id="o-header-2013" class="cms_header">
	<div class="w" id="header-2013">
		<div id="logo-2013" class="ld"><a href="/" hidefocus="true" clstag="homepage|keycount|home2013|02a"><b></b><img src="/images/pekka-logo.jpg" width="150" height="62" alt="皮卡"></a></div>
		<!--logo end-->
		<div id="search-2013">
	...
	<div class="w">
		<div id="nav-2013">
			<div id="categorys-2013" class="categorys-2014">
				<div class="mt ld" style="display: block;height: 40px;line-height: 40px;color: #fff;text-align: center;font-size: 15px;">
					 玩具分类
				</div>
				<div id="_JD_ALLSORT" class="mc">
					...
					<!-- <div class="extra">
						<a {if="" pageconfig.ishome}clstag="homepage|keycount|home2013|0614a"
							{="" if}="" href="http://www.jd.com/allSort.aspx">玩具分类</a>
					</div> -->
				</div>
			</div>
			<div id="treasure" clstag="homepage|keycount|home2013|08a"></div>
				<ul id="navitems-2013">
					<li class="fore1" id="nav-home" clstag="homepage|keycount|home2013|07a"><a href="http://localhost:8085/search.html?q=遥控车">遥控车</a></li>
					<li class="fore2" id="nav-fashion" clstag="homepage|keycount|home2013|07b"><a href="http://localhost:8085/search.html?q=机器人">机器人</a></li>
					<li class="fore3" id="nav-chaoshi" clstag="homepage|keycount|home2013|07c"><a href="http://localhost:8085/search.html?q=娃娃">娃娃</a></li>
					<li class="fore4" id="nav-tuan" clstag="homepage|keycount|home2013|07d"><a href="http://localhost:8085/search.html?q=乐高" >乐高</a></li>
